...
int chapter_3(int test) {
  ...
  sm_cx_let(test_parent_cx, sm_new_symbol("a", 1), (sm_object *)sm_new_double(1));
  sm_cx_let(test_parent_cx, sm_new_symbol("b", 1), (sm_object *)sm_new_double(2));
  sm_cx_let(test_parent_cx, sm_new_symbol("ab", 2), (sm_object *)sm_new_double(3));

  sm_cx_let(test_cx, sm_new_symbol("a", 1), (sm_object *)sm_new_double(7));
