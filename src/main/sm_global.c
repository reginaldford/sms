...
uint32_t sm_global_fn_name_len(uint32_t which) {
  static uint64_t response_len[] = {
    ...
    6, 5, 3, 7, 6, 4, 6,  8, 12, 5, 5,  4, 2, 2, 2, 1, 1,  2, 2, 0,  0, 0,  3, 3, 5, 5, 2,  11,
    5, 5, 5, 5, 8, 8, 12, 5, 4,  7, 6,  8, 6, 8, 5, 9, 8,  7, 8, 10, 8, 9,  6, 6, 6, 9, 11, 8,
    8, 3, 3, 6, 4, 4, 6,  4, 5,  5, 4,  3, 3, 2, 3, 3, 4,  7, 8, 11, 8, 11, 4, 7, 7, 7, 6,  6,
    6, 6, 7, 8, 4, 8, 7,  9, 11, 8, 6,  9, 8, 3, 6, 6, 6,  8, 7, 9,  9, 9,  8, 6, 6, 8, 7,  0,
    0, 8, 4, 7, 4, 4, 5,  6, 6,  6, 11, 8, 8, 3, 5, 8, 10, 9, 7, 8,  1
...
uint32_t sm_global_num_fns() {
  static const uint32_t num_fns = 189;
  return num_fns;
}
