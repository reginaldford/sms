...
unsigned int sm_global_fn_name_len(unsigned short int which) {
  static long unsigned int response_len[] = {
    4, 4, 5, 4, 2, 2,  3, 3, 1, 1, 1, 1, 2, 3, 1, 1, 1,  1, 1, 3, 3, 3, 4, 4, 4, 4, 4, 4, 5, 5,  5,
    3, 3, 3, 4, 4, 4,  4, 4, 4, 5, 5, 5, 2, 3, 3, 4, 3,  4, 4, 3, 2, 2, 3, 6, 5, 7, 4, 6, 8, 12, 5,
    5, 4, 2, 1, 1, 2,  2, 0, 0, 0, 5, 3, 5, 5, 5, 5, 12, 5, 4, 7, 6, 7, 6, 8, 5, 9, 8, 7, 8, 10, 8,
    9, 6, 6, 6, 9, 10, 8, 8, 6, 6, 6, 4, 4, 6, 4, 5, 3,  2, 3, 7, 6, 6, 6, 7, 8, 4, 8, 7, 9, 11, 9,
    6, 6, 8, 6, 5, 8,  6, 6, 8, 7, 9, 9, 9, 8, 6, 6, 8,  7, 0, 0, 8, 4, 7, 4, 4, 5, 1};
...
unsigned int sm_global_num_fns() {
  static const unsigned short int num_fns = 151;
  return num_fns;
}
