...
char *sm_global_fn_name(unsigned short int which) {
  ...
  static char *response[] = {"exit",       "help",        "clear",       "self",
                             "ls",         "cd",          "pwd",         "let",
                             "=",          "rm",          ".",           "+",
                             "-",          "*",           "/",           "^",
                             "sin",        "cos",         "tan",         "asin",
                             ...
                             "csc",        "sec",         "cot",         "acsc",
                             "asec",       "acot",        "csch",        "sech",
                             "coth",       "acsch",       "asech",       "acoth",
                             "ln",         "log",         "exp",         "sqrt",
                             "abs",        "diff",        "simp",        "int",
                             "if",         "if",          "map",         "parent",
                             "while",      "eval",        "eval_fast",   "parse",
                             "meta",       "==",          "<",           ">",
                             "<=",         ">=",          ";",           "",
                             "",           "to_str",      "print",       "input",
                             "file_parse", "file_tostr",  "file_toblk",  "file_exists",
                             "file_date",  "file_cp",     "file_mv",     "file_rm",
                             "file_size",  "str_tofile",  "csv_toarr",   "arr_tocsv",
                             "new_arr",    "arr+",        "arr*",        "part",
                             "size",       "random",      "round",       "not",
                             "or",         "xor",         "str_size",    "str+",
                             "str_get",    "str_set",     "str_map",     "str_find",
                             "str_findr",  "str_split",   "str_part",    "str_unescape",
                             "str_escape", "str_setchar", "str_getchar", "str_tonums",
                             "str_tofile", "str_cmp",     "str_repeat",  "str_toblk",
                             "new_str",    "to_str",      "to_strfmt",   "new_blk",
                             "blk_map",    "blk_unite",   "blk_part",    "blk_tonums",
                             "nums_toblk", "blk_tofile",  "blk_output",  "blk_set",
                             "blk_get",    "blk_tostr",   "blk_size",    "",
                             "",           "siblings",    "prim",        "date_str",
                             "date",       "time",        "sleep",       "?"};
...
unsigned int sm_global_fn_name_len(unsigned short int which) {
  static long unsigned int response_len[] = {
    4, 4, 5, 4, 2, 2, 3, 3,  1,  2,  1,  1, 1, 1, 1,  1,  3,  3,  3,  4,  4,  4,  4,  4,  4, 5,  5,
    5, 3, 3, 3, 4, 4, 4, 4,  4,  4,  5,  5, 5, 2, 3,  3,  4,  3,  4,  4,  3,  2,  2,  3,  6, 5,  4,
    9, 5, 4, 2, 1, 1, 2, 2,  1,  0,  0,  6, 5, 5, 10, 10, 10, 11, 9,  7,  7,  7,  9,  10, 9, 9,  7,
    4, 4, 4, 4, 6, 5, 3, 2,  3,  8,  4,  7, 7, 7, 8,  9,  9,  8,  12, 10, 11, 11, 10, 10, 7, 10, 9,
    7, 6, 9, 7, 7, 9, 8, 10, 10, 10, 10, 7, 7, 9, 8,  0,  0,  8,  4,  8,  4,  4,  5,  1};
