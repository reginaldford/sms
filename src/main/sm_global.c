...
char *sm_global_fn_name(unsigned short int which) {
  ...
  static char *response[] = {
    "+",    "-",     "*",        "/",         "sqrt", "sin",  "cos",  "tan",    "sinh", "cosh",
    "tanh", "^",     "csc",      "sec",       "cot",  "csch", "sech", "coth",   "ln",   "exp",
    "abs",  "diff",  "simp",     "=",         "==",   "<",    ">",    "if",     "if",   "let",
    "",     "",      "siblings", "prim",      "",     "",     ".",    "parent", "",     "map",
    "size", "while", "print",    "to_string", "eval", "?"};
...
unsigned int sm_global_fn_name_len(unsigned short int which) {
  static long unsigned int response_len[] = {1, 1, 1, 1, 4, 3, 3, 3, 4, 4, 4, 1, 3, 3, 3, 4,
                                             4, 4, 2, 3, 3, 4, 4, 1, 2, 1, 1, 2, 2, 3, 0, 0,
                                             8, 4, 0, 0, 1, 6, 0, 3, 4, 5, 5, 9, 4, 1};
...
unsigned int sm_global_num_fns() {
  static const unsigned short int num_fns = 46;
  return num_fns;
}
