...
char *sm_global_fn_name(unsigned short int which) {
  ...
  static char *response[] = {
    ...
    "size",       "while", "print", "to_string", "eval", "parse",  "parse_file", "read_file",
    "write_file", "?"};
...
unsigned int sm_global_fn_name_len(unsigned short int which) {
  static long unsigned int response_len[] = {1, 1, 1, 1, 4, 3, 3, 3, 4, 4, 4, 1, 3,  3, 3,  4, 4,
                                             4, 2, 3, 3, 4, 4, 1, 2, 1, 1, 2, 2, 3,  0, 0,  8, 4,
                                             0, 0, 1, 6, 0, 3, 4, 5, 5, 9, 4, 5, 10, 9, 10, 1};
...
unsigned int sm_global_num_fns() {
  static const unsigned short int num_fns = 50;
  return num_fns;
}
