...
unsigned int sm_global_fn_name_len(unsigned short int which) {
  static long unsigned int response_len[] = {
    4, 4, 5, 4, 2, 2,  3,  3,  6,  2, 1, 1, 1, 1,  1,  1,  3,  3,  3,  4, 4,  4,  4,  4,
    4, 5, 5, 5, 3, 3,  3,  4,  4,  4, 4, 4, 4, 5,  5,  5,  2,  3,  3,  4, 3,  4,  4,  3,
    2, 2, 3, 6, 5, 4,  9,  5,  4,  2, 1, 1, 2, 2,  1,  0,  4,  0,  6,  5, 5,  10, 10, 6,
    5, 3, 2, 3, 8, 4,  7,  7,  7,  8, 9, 9, 8, 12, 10, 11, 11, 10, 10, 7, 10, 9,  7,  6,
    9, 7, 7, 9, 8, 10, 10, 10, 10, 7, 7, 9, 8, 0,  0,  8,  4,  8,  4,  4, 5,  1};
...
unsigned int sm_global_num_fns() {
  static const unsigned short int num_fns = 118;
  return num_fns;
}
