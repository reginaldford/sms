...
SOURCES=src/lex.yy.c src/y.tab.c src/sm_object.c src/sm_symbol.c src/sm_memory_heap.c src/sm_string.c src/sm_expression.c src/sm_double.c src/sm_context.c src/sm_commands.c src/sm_global.c src/sm_gc.c src/sm_terminal.c src/sm_key_value.c src/sm_pointer.c src/sm_engine.c src/sm_meta.c src/sm_signal.c src/sm_spacer.c

HEADERS=               src/sms.h src/sm_object.h src/sm_symbol.h src/sm_memory_heap.h src/sm_string.h src/sm_expression.h src/sm_double.h src/sm_context.h src/sm_commands.h src/sm_global.h src/sm_gc.h src/sm_terminal.h src/sm_key_value.h src/sm_pointer.h src/sm_engine.h src/sm_meta.h src/sm_signal.h src/sm_spacer.h
