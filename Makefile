...
OBJS2    	  		:= $(SRCS2:%=$(BUILD_DIR)/%.dbg.o)
OBJS3    	  		:= $(SRCS3:%=$(BUILD_DIR)/%.dbg.o)
INCLUDE 	  		:= include
INSTALL_DIR			:= /usr/bin
TARGET_SMS			:= sms
...
# sms_test executable
bin/$(TARGET_TEST): $(OBJS0) $(OBJS1) $(OBJS2)
	$(CC_DEBUG) $(CFLAGS_DEBUG) -lm $(OBJS1) $(OBJS0) $(OBJS2) -o $@ 

# sms_kernel_test executable
bin/$(TARGET_KT): $(OBJS0) $(OBJS1) $(OBJS3)
	$(CC_DEBUG) $(CFLAGS_DEBUG) -lm $(OBJS1) $(OBJS0) $(OBJS3) -o $@ 
